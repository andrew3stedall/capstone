...
- Completed quality passes: Days 1–8.
- Exactly one next increment: quality-improvement pass — Day 9, MEN Arrangement and Normal-Current Paths.
...
- `docs/assets/learning/6-week/day-08-earthing-terminology-and-component-identification/a-label-is-not-a-proven-role.svg`
...
- Exact definitions, conductor requirements, connection locations, permitted arrangements, exceptions, supply relationships and jurisdiction-specific duties require current authorised information and qualified review.
- N-A-M-E-S, the evidence and claim grades, component-role ledger, fictional scenarios, Mermaid diagrams, transfer tasks and rubric are original educational models.
...
- The module authorises no opening, cover removal, isolation, proving, testing, conductor tracing, continuity testing, disconnection, reconnection, bridging, alteration, energisation or commissioning.

## Quality-pass tracker

- Modules awaiting one quality-improvement pass: Days 9–42.
- Quality-improvement passes completed: Days 1–8.
- Selection rule: choose the first module without a recorded pass; persistent review flags do not cause reselection.

## Increment review

- Day 8 retains the exact eight required beats and compatible YAML metadata.
...
- Module and note navigation are reciprocal and point to Days 7 and 9.
- Both SVGs use white backgrounds, black line art, semantic image metadata, descriptive alt text and instructional captions.
- Five evidence grades, four claim grades, explicit dependencies and reopening triggers prevent labels or visual clues becoming unsupported safety claims.
...
**Quality-improvement pass — Day 9: MEN Arrangement and Normal-Current Paths**
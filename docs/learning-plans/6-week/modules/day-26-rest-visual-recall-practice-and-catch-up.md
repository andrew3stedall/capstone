---
id: 6w-day-26-rest-visual-recall-practice-and-catch-up
title: Day 26 — Rest, Visual-Recall Practice and Catch-Up
...
![A learner redraws two small diagrams, corrects one error and stops at a time limit](../../../assets/learning/6-week/day-26-rest-visual-recall-practice-and-catch-up/redraw-correct-stop.svg)
...
```mermaid
flowchart TD
    A[Rate energy and concentration] --> B[Closed-note redraw]
    B --> C[Compare with module]
    C --> D{High-value error}
    D -->|No| E[Record retrieval success]
    D -->|Yes| F[Correct smallest useful gap]
    F --> G[Fresh redraw or scenario]
    E --> H[Readiness decision]
    G --> H
    H --> I[Stop by 30 minutes]
```

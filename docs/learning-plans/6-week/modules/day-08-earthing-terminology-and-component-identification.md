---
id: 6w-day-08-earthing-terminology-and-component-identification
title: Day 8 — Earthing Terminology and Component Identification
...
```mermaid
flowchart LR
    S["Source relationship"] --> N["Neutral conductor role"]
    S --> M["Designated MEN relationship"]
    M --> T["Main earthing terminal or relevant junction"]
    T --> P["Protective earthing conductors"]
    T --> B["Required bonding connections"]
    T --> C["Main earthing conductor"]
    C --> E["Earthing electrode"]
```

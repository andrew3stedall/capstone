...
- **Completed:** Plan framework; Day 1 — Exam Orientation and Wiring Rules Navigation; Day 2 — Fundamental Safety Principles; Day 3 — Overcurrent Protection; Day 4 — RCD Protection and Additional Protection; Day 5 — Rest, Retrieval and Catch-Up; Day 6A — Earthing Terminology and Component Roles; Day 6B — MEN Fault-Current Path.
- **Current block:** None.
- **Next block:** [[Day 06C - Earthing and MEN Fault Scenarios]].
...
- **Review state:** Day 6B is safety-critical and `review-required`. Exact MEN arrangements, connection points, conductor requirements, fault-loop methods, protective-device characteristics, operating times, touch-voltage criteria, test procedures, alternate-supply conditions, exceptions and clause references remain `reference_check_required`.
...
- `docs/learning-plans/4-week/modules/day-06b-men-fault-current-path.md`
- `docs/assets/learning/4-week/day-06b-men-fault-current-path/follow-the-loop.svg`
- `docs/assets/learning/4-week/day-06b-men-fault-current-path/every-link-counts.svg`
- `docs/knowledge-base/Day 06B - MEN Fault-Current Path.md`
- `docs/learning-plans/4-week/MASTER_PLAN.md`
- `docs/learning-plans/4-week/AUTOMATION_STATUS.md`

## Review flags

- Day 6B is `review-required` and safety-critical.
- `reference_check_required`: exact MEN connection locations, permitted arrangements, separate-building conditions and multiple or alternate-supply arrangements.
- `reference_check_required`: protective-earthing, neutral, main-earthing and bonding conductor requirements, continuity, routing, terminations and connection integrity.
- `reference_check_required`: fault-loop impedance calculation and test methods, source impedance assumptions and acceptance criteria.
- `reference_check_required`: protective-device characteristics, required operating conditions, disconnection times and coordination claims.
- `reference_check_required`: touch-voltage criteria, RCD interactions, test procedures, expected results and RTO assessment requirements.
- No copied standards wording, table, figure or diagram was added.
- No exact clause number, current value, impedance value, disconnection time, conductor size or universal field arrangement was asserted.
- Day 6B must not be labelled `technically-reviewed` until checked by a suitably qualified reviewer against current authorised sources.

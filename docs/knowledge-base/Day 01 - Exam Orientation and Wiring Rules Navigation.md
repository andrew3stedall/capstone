...
This note maps the source-navigation capability developed in the first block of the four-week program.

## Learning module

- [Day 1 — Exam Orientation and Wiring Rules Navigation](../learning-plans/4-week/modules/day-01-exam-orientation-and-wiring-rules-navigation.md)

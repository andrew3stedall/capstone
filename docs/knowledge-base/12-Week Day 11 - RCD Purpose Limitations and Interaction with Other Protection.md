---
title: 12-Week Day 11 - RCD Purpose Limitations and Interaction with Other Protection
type: learning-note
program: twelve-week
...
- [Day 11 — RCD Purpose, Limitations and Interaction with Other Protection](../learning-plans/12-week/modules/day-11-rcd-purpose-limitations-and-interaction-with-other-protection.md)
...
An RCD does not automatically establish:
...
This note uses original explanations, workflows, diagrams and scenarios. It does not reproduce standards tables, figures, device curves, systematic wording, exact technical values or official assessment material. It remains `review-required` and not `technically-reviewed`.
